...
public class MainActivity extends AppCompatActivity {
    ...
    private void showRegisterDialog() {
        ...
        final MaterialEditText editDob = register_Layout.findViewById(R.id.edtDob);
        final MaterialEditText editAddress = register_Layout.findViewById(R.id.edtAddress);
                ...
                auth.createUserWithEmailAndPassword(editEmail.getText().toString(),editPassword.getText().toString())
                        .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                            ...
                            public void onSuccess(AuthResult authResult) {
                                ...
                                rider.setDob(editDob.getText().toString());
                                rider.setAddress(editAddress.getText().toString());
//                                rider.setDob(editDob.getText().toString());
//                                rider.setAddress(editAddress.getText().toString());
